...
from quantize.ruquant import ruquant
...
def main():
    ...
    parser.add_argument("--seed", type=int, default=444, help="Seed for sampling the calibration data.")
    ...
    if args.epochs > 0:
        assert args.lwc or args.let or args.lh
        
    if (args.wbits<16 and args.wbits>=8) or (args.abits<16 and args.abits>=8):
        args.deactive_amp = True

    args.quant_method = "ruquant"
